...
<?php include('navigation.php'); ?>
    ...
    <div class="container d-flex h-100 align-items-center">
      <div class="mx-auto text-center">
        <h1 class="mx-auto my-0 text-uppercase">Course type</h1>
...
$result = $conn->query($sql);
    while($row = $result->fetch_assoc()) {
         ...
         ?>
                    ...
                    <tr  class="info-row">
                        <td class="colhead1"><?php echo $row["courseType"];?>
                        </td>
           ...
           <tr>
           <td>
               <h4>Add a new course type</h4>
               <form action="Enrollments_add_course_type_ap.php" method=post>
                               <p>course type name</p>
                                <input type="Text" name="NewCourseType" >
                   ...
                   <br>
                                <input type="submit" alt="submit" fill="orange" value="add new course type" width="20" height="20">
